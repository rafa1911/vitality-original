...
<body>
    <div class="container">
        ...
        <form method="POST" action="./salvar_ficha.php?id=<?php echo $modelo_id?>" id="fichaForm">
            <fieldset>
                ...
                <?php foreach ($perguntas as $id_pergunta => $detalhes): ?>
                    <div class="pergunta-item">
                        ...
                        <?php if ($detalhes['tipo'] === 'text'): ?>
                            <input type="text" id="pergunta-<?php echo $id_pergunta; ?>" name="respostas[<?php echo $id_pergunta; ?>]" class="form-input" required placeholder="Digite sua resposta" disabled>

                        <?php elseif ($detalhes['tipo'] === 'radio'): ?>
                            <div class="opcoes-container">
                                <?php foreach ($detalhes['opcoes'] as $index => $opcao): ?>
                                    <input type="radio" id="opcao-<?php echo $id_pergunta . '-' . $index; ?>" name="respostas[<?php echo $id_pergunta; ?>]" value="<?php echo $opcao['opcao']; ?>" class="form-input-radio" disabled>
